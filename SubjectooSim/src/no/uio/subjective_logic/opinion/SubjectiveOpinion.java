...
public class SubjectiveOpinion extends OpinionBase
{
  ...
  public static final SubjectiveOpinion UNCERTAIN = new SubjectiveOpinion(0.0D, 0.0D, 1.0D, 0.5D); // new binomial opinion completely uncertain about the node

  private double a = 0.5D; // base rate

  private double b = 0.0D; // belief

  private double d = 0.0D; // disbelief
  ...
  private double u = 1.0D; // uncertainty

  private static SubjectiveOpinion abduction(SubjectiveOpinion y, SubjectiveOpinion yTx, SubjectiveOpinion yFx, double baseRateX) // abduction operator out of scope
  ...
  private static SubjectiveOpinion consensus(SubjectiveOpinion x, SubjectiveOpinion y) throws OpinionArithmeticException
  {
    if ((x == null) || (y == null)) {
      throw new NullPointerException();
    }
  ...
  public static SubjectiveOpinion createDogmaticOpinion(double expectation, double atomcity)
  {
  ...
  private static SubjectiveOpinion clippedOpinion(double b, double u, double a) throws OpinionArithmeticException  // ???????????????
  {
    ...
    double e = OpinionBase.constrain(b + a * u); // constraint the projected probability
    double sum = u + b;
  ...
  public static SubjectiveOpinion fuse(Collection<? extends Opinion> opinions) throws OpinionArithmeticException
  {
    if (opinions == null) {
      throw new NullPointerException();
    }
  ...
  private static void maximizeUncertainty(SubjectiveOpinion x)
  {
    ...
    synchronized (x)
    {
      ...
      if (x.e <= x.a)
      {
        ...
        if (x.a > 0.0D)
        {
          d = OpinionBase.adjust(1.0D - x.u - x.b / x.a);
      ...
      else
      {
        ...
        if (x.a < 1.0D)
        {
          b = OpinionBase.adjust(1.0D - x.u - x.d / (1.0D - x.a));
  ...
  public boolean equals(Object obj)
  {
    ...
    public int hashCode() {
        ...
        hash = 71 * hash + (int) (Double.doubleToLongBits(this.u) ^ (Double.doubleToLongBits(this.u) >>> 32));
        return hash;
    }
  ...
  public final void setAtomicity(double atomicity)
  {
    ...
    this.changeSupport.firePropertyChange("atomicity", old, this.a);
  }
  ...
  {
    return String.format(TO_STRING_FORMAT, this.b, this.d, this.u, this.a, getExpectation());
  }
  ...
  //---------------------------------------------------------------------------------------------------
  public SubjectiveOpinion copy()
  {
	  return new SubjectiveOpinion(this.b,this.d,this.u,this.a);
  }
  //---------------------------------------------------------------------------------------------------
}